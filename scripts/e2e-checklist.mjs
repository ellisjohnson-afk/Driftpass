...
console.log('  3. Open /scan — select partner/service, enter PIN → Approved')
console.log('  4. Check /dashboard — credit balance and redemption history updated')
console.log('  5. /account → Manage billing → returns to /account')
